...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white via-lime-50 to-white">
      ...
      {/* Header/Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm border-b border-lime-100">
      ...
      {/* Features Section */}
      <section className="py-20 px-4 bg-gradient-to-br from-lime-50 to-transparent">
      ...
      {/* Footer */}
      <footer className="border-t border-lime-100 bg-gradient-to-b from-white to-lime-50 py-12 px-4">
